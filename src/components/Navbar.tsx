        ...
        <div className="flex items-center gap-2">
          <nav
            ...
            <div className="absolute inset-0 rounded-[inherit] pointer-events-none" style={{
              padding: '1.125px',
              background: `linear-gradient(160deg, ${isDark ? 'rgba(255,255,255,0.25)' : 'rgba(255,255,255,0.7)'} 0%, ${isDark ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.2)'} 50%, ${isDark ? 'rgba(255,255,255,0.25)' : 'rgba(255,255,255,0.7)'} 100%)`,
