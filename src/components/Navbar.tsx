        ...
        >
          ...
          <form
            onSubmit={async (e) => {
              ...
              try {
                const url = `https://script.google.com/macros/s/AKfycbzbN_swWjEPodgDcaB-brFxpeW4pIBn7nPf6XDO4bkvyFJquU5CMvi8GDnl1jND5nSaCw/exec?hash=${encodeURIComponent(hashHex)}`;
      ...
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50">
        <div className="flex items-center gap-2">
          <motion.nav
            ...
            className="px-2 pr-3 flex-row flex items-center justify-start gap-[8px] rounded-[21.6px] py-[8px] relative overflow-hidden md:min-w-[540px]"
            style={{
              background: 'hsla(var(--glass-bg))',
              backdropFilter: 'blur(var(--glass-blur)) saturate(var(--glass-saturation))',
              WebkitBackdropFilter: 'blur(var(--glass-blur)) saturate(var(--glass-saturation))',
          ...
          {/* Separator — desktop only, outside nav to avoid clipping */}
          ...
          {/* HiT button — outside nav to avoid clipping */}
