  ...
  return (
    <main className="relative z-10 pt-28 content-padding min-h-screen">
      <div className="max-w-4xl mx-auto">
        <ScrollReveal>
          <h1 className="text-4xl sm:text-6xl font-bold mb-8 gradient-text-gray">Hakkımda</h1>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.2}>
          <GlassCard className="p-10 sm:p-14 mb-8">
            <h3 className="text-xl font-bold mb-6 gradient-text-gray">Yaklaşım ve Değerler</h3>
